...
(9, '今日心情记录', '用文字和简单插画记录今天的心情变化，捕捉情绪的流动', '今天发生了什么让你开心的小事？有没有什么小烦恼？用颜色来表达心情吧。可以画一个简单的表情，配上几句话。', '三栏式布局：左侧日期天气，中间心情插画，右侧文字描述', '😊', 1),
(9, '周度生活回顾', '回顾这一周的生活点滴，选出印象最深刻的3件事', '这一周最大的收获是什么？有什么遗憾？下周想做什么改变？可以用贴纸和时间轴来组织内容。', '时间轴布局 + 贴纸拼贴', '📅', 2),
(9, '晨间日记', '早起的第一笔，记录梦境、灵感或今日期待', '昨晚做了什么梦？今天最期待什么？给自己一句鼓励的话。配以清新简洁的排版。', '一页式留白排版，大面积空白 + 手写字体', '🌅', 3),
(9, '睡前碎碎念', '入睡前的随想，记录一天中没说出口的话', '今天最感激的一件事？有什么想对明天的自己说的？用温柔的色调和贴纸营造氛围。', '手写信格式，配以小装饰边框', '🌙', 4),

(10, '春节手账特辑', '记录春节的团圆时光，贴上年味满满的照片和贴纸', '年夜饭吃了什么？收到压岁钱了吗？和家人有什么有趣的对话？可以贴上红包、福字、照片。', '红色主题拼贴，大量中国红元素，左右分栏', '🧧', 1),
(10, '生日派对记录', '记录生日这一天的特别时刻，让这个日子有仪式感', '许了什么愿望？收到了什么礼物？和谁一起庆祝？贴上生日贺卡、蛋糕照片。', '居中构图，彩带装饰，数字高亮', '🎂', 2),
(10, '情人节专属', '记录甜蜜的二人时光或单身的浪漫仪式感', '约会去了哪里？对方做了什么让你感动的事？一个人也要好好爱自己哦。', '粉紫色系，心形装饰，双栏对话式排版', '💝', 3),
(10, '圣诞节日志', '记录圣诞季的温馨，从装饰圣诞树到交换礼物', '圣诞愿望清单是什么？怎么度过圣诞节的？贴上圣诞树、雪花贴纸、礼物包装纸。', '绿红金三色搭配，雪花边框，拼贴风格', '🎄', 4),

(11, '旅行出发前准备', '写下出发前的期待与准备清单，期待值拉满', '目的地是哪里？要带什么行李？有哪些必去的地方？可以贴上机票、车票、行程单。', '清单式布局 + 地图装饰 + 便签', '🎒', 1),
(11, '每日行程记录', '用手账记录旅行中的每一天，图文并茂', '今天去了哪些地方？吃了什么好吃的？遇到了什么有趣的人？贴上景区门票、照片。', '图文混排拼贴风，多图多便签', '🗺️', 2),
(11, '美食探店合集', '旅途中的美食不能错过，每家店都值得被记录', '店名、地址、点了什么、口味评分、人均消费？贴上餐巾纸、菜单、美食照片。', '网格布局，每个餐厅一个小卡片', '🍽️', 3),
(11, '旅行感悟总结', '旅行结束后的总结，记录这次旅程的收获与感动', '最大的收获是什么？最难忘的瞬间？下次旅行想去哪里？配以手绘地图和盖章。', '总结页式排版，大面积文字 + 装饰', '💫', 4),

(12, '书中金句摘录', '摘抄书中打动你的句子，配上自己的解读', '书名、作者、页码、原文摘录、为什么这句话打动了你？配以简单的书本插画。', '左右两栏：左侧引用，右侧感悟', '✍️', 1),
(12, '读书心得笔记', '读完一本书后的完整读后感，记录思考与启发', '这本书讲了什么？核心观点是什么？对你有什么启发？配以封面插画和标签。', '卡片式分点布局，配以书脊装饰', '📖', 2),
(12, '本月书单分享', '分享这个月读的书，给每本书写一句短评', '读了几本书？最推荐哪本？下个月的阅读计划是什么？配以书籍封面拼贴。', '书籍排列式布局，封面缩略图 + 星级评分', '📚', 3),
(12, '角色人物分析', '对书中印象深刻的人物进行分析和记录', '人物性格、经典台词、人物关系图、你的看法？配以人物插画和关系连线。', '思维导图式布局 + 人物小卡片', '👤', 4),

(13, '早餐打卡', '记录每天的早餐，开启元气满满的一天', '今天早餐吃了什么？在哪里吃的？自己做的还是外卖？配上美食照片和食谱小贴士。', '网格布局，每日一格，配以食物简笔画', '🍳', 1),
(13, '探店美食测评', '详细记录一家餐厅的用餐体验，给其他吃货参考', '店名、环境、服务、每道菜的点评、性价比？贴上菜单、小票、美食照片。', '评分卡式布局，多维度雷达图展示', '⭐', 2),
(13, '家常菜食谱', '记录自己做的菜，写上配方和步骤供日后参考', '菜名、食材清单、步骤、小贴士、成品照片？配以手绘食材和步骤图。', '步骤式纵向排版，分步配图', '👨‍🍳', 3),
(13, '下午茶时光', '记录悠闲的下午茶时刻，甜点配咖啡的小确幸', '咖啡馆名称、环境氛围、点了什么、搭配的书或音乐？贴上杯垫、糖包、照片。', '文艺风左右排版，柔和色调，大量留白', '☕', 4),

(14, '电影观后感', '看完一部电影后的完整观感，记录情绪与思考', '片名、导演、主演、剧情简介、打动你的场景、主题思考？贴电影票根、海报。', '海报大图 + 影评文字，双栏排版', '🎞️', 1),
(14, '剧集追剧记录', '追一部剧的过程记录，每集的感想和推测', '剧名、集数、当前进度、每集亮点、剧情预测？贴剧照和剧集海报。', '时间轴+进度条展示，分集卡片式', '📺', 2),
(14, '纪录片札记', '看完纪录片的知识笔记和感悟', '片名、主题、知识点摘录、你的思考、推荐理由？配以数据图表和地图。', '信息图风格，数据可视化 + 引用框', '🎓', 3),
(14, '本月观影总结', '汇总本月看过的所有影片，做一个观影报告', '观影数量、类型分布、最佳影片、年度榜单进度？配以海报拼贴和统计图表。', '数据看板式布局，图表+评分列表', '🏆', 4),

(15, '周工作计划', '规划一周的工作任务，有条不紊地推进', '本周目标、每日待办、重点项目、时间分配？配以进度条和优先级标记。', '甘特图风格，分日分任务块', '📋', 1),
(15, '月度目标拆解', '把月度大目标拆解成可执行的小任务', '本月核心目标、关键结果、里程碑、每周计划？配以目标追踪进度环。', '目标树状图 + 里程碑时间轴', '🎯', 2),
(15, '工作复盘总结', '周/月末复盘，总结经验教训，持续改进', '完成了什么？哪些做得好？哪些需要改进？下一步计划？配以数据对比。', 'SWOT分析布局，四象限分区', '🔍', 3),
(15, '灵感创意收集', '工作中闪现的灵感和好点子，随时记录', '创意来源、适用场景、具体想法、可实施性？贴上便签、草图、剪报。', '便签墙风格，彩色便签自由排列', '💡', 4),

(16, '早起打卡挑战', '记录每天早起的时间和感受，培养早睡早起习惯', '起床时间、睡眠质量、早起做了什么、心情指数？配以折线图展示趋势。', '日历热力图 + 每日心情打卡格', '🌞', 1),
(16, '运动健身日记', '记录每次运动的内容和身体变化', '运动类型、时长、消耗卡路里、身体感受、体重变化？配以身体数据追踪图。', '数据追踪看板，健身数据可视化', '🏃', 2),
(16, '每日读书打卡', '坚持每天阅读，记录阅读进度和收获', '书名、今日读了多少页、摘录金句、阅读感受？配以阅读进度条和书籍堆叠图。', '书籍进度列表 + 每日阅读时长打卡', '📖', 3),
(16, '喝水健康提醒', '记录每天的饮水量，保持健康的生活习惯', '目标饮水量、每次喝水记录、是否达标、皮肤状态？配以水杯图标打卡和折线图。', '8杯水打卡格 + 日/周/月达标统计', '💧', 4);
